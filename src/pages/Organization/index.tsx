          ...
          <main className="bg-gray-100 min-h-screen">
            <div className="pt-6">
              <div className="max-w-7xl mx-auto px-4 sm:px-6 md:px-8 flex flex-row justify-between items-center">
                ...
                <button
                  type="button"
                  className="inline-flex items-center px-4 py-2 border border-gray-300 shadow-sm text-sm font-medium rounded-md text-gray-700 bg-mono-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500"
                >
                  Merge Orgs
                </button>
              </div>
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 md:px-8">
              <div className="w-full bg-mono-white drop-shadow-md px-4 py-4 my-4">
